...
<nav class="navbar navbar-inverse" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="./index.php">ВА "SovTrans"</a>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			...
			<?php if ($user_logged==0) {
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="./index.php?page=pilot_register"><span class="glyphicon glyphicon-user"></span> Регистрация</a></li>
					<li><a href="#myModal" role="button" data-toggle="modal" rel="tooltip" data-original-title='Hello'><span class="glyphicon glyphicon-log-in"></span>Вход</a></li>
				</ul>
			<?php
			}
			else{
				?>
				<ul class="nav navbar-nav navbar-right" >
					<li><a href = "./index_vam.php" role = "button" ><span class="glyphicon glyphicon-cog" ></span> Система</a></li>
					<li><a href = "./index.php?page=logout" ><span class="glyphicon glyphicon-log-out" ></span > Выход</a ></li>
				</ul>
			<?php
			}
			?>
